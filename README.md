...
2. In the `scripts/` directory of the current problem set, create a file called `ps<#>-dev-<your-name>.qmd`. Here, you will work through the entire problem set on your own. It doesn't have to be perfect. Just make sure to attempt every problem, noting any questions/confusions.
    - If you need to alter any data prep during your individual work, you must open a PR to the main branch with those changes, so everyone can update their dev branches
